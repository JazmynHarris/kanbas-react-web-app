    ...
    return (
        <div id ="wd-lab1">
            ...
            <div id= "wd-h-tag">
                ...
                than the plain text and their subsection headings. This document uses headings to introduce 
                topics such as HTML Documents, HTML Tags, Heading Tags, etc. HTML heading tags can be used to 
                format plain text so that it renders in a browser as large headings. There are 6 heading tags 
            ...
            <div id="wd-lists">
                ...
                My favorite recipe:
                <ol id="wd-your-faborite-recipe">
                    <li>Take two slice of bread</li>
                    <li>Spread peanut butter on one side of one slice</li>
                    <li>Spread jam on one side of the second slice of bread</li>
                    <li>Place one slice of bread atop the other with condiments facing each other</li>
                </ol>
            ...
            <div id="wd-forms">
                ...
                <form id="wd-text-fields">
                    ...
                    Please
                    <a id="wd-github" href="https://github.com/JazmynHarris?tab=repositories">click here</a>
                    to get Github<br />
